        ...
        <div className='w-full'>
          <div className="relative">
            ...
            <Input
              ...
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 p-2 bg-white border rounded-[8px] h-20"
            />
          </div>
        </div>
      </div>
      <div className='flex flex-col justify-center items-center mt-8'>
        <div className='w-[1054px] flex-col justify-between mb-4'>
          <div className=' flex justify-between'>
            ...
            <Button className="w-[178px] h-[48px] text-lg leading-[23px] rounded-[8px] font-muli" variant="custom">
              Novo Card
            </Button>
          </div>
          <div className='mt-6'>
